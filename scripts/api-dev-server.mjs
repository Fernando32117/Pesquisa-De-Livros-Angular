/**
 * Servidor Express mínimo para desenvolvimento local.
 * Expõe apenas /api/books, mantendo a API key fora do bundle do browser.
 * Em produção, essa rota fica no server.ts do SSR.
 */
